        ...
        <div className="content-container">
          ...
          <div className="text-content">
            ...
            <h3>More Than Just a Waterpark</h3>
              <p>
                Runaway Rapids is part of the Keansburg Amusement Park, making
                it an ideal spot for a full day of family fun. After enjoying
                the waterpark, head over to the amusement park for even more
